...
import { buildEntityProviderOptions } from '../githubOrganization/githubEntityProvider';
...
export default async function createPlugin(
  ...
  builder.addEntityProvider(
    GithubOrgEntityProvider.fromConfig(env.config, buildEntityProviderOptions(env)),
  );
